const socialIcon: Array<{ icon: React.ReactElement; href: string; label: string }> =
  [
      {
          icon: (
              <svg
      ...
      },
      {
          ...
          href: "https://discord.com/channels/vishwaashish",
      },
      // {
      //   icon: (
      //     <svg
                    ...
                    <div className="flex space-x-5 justify-center  sm:justify-end md:mt-0">
                        {socialIcon.map(item => (
                            <a
                                href={item.href}
                                key={item.label}
                                className="brightness-100 border-primary hover:brightness-125 "
                            >
                                {item.icon}
