...
function CodeSnapShot() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        {...transition(0.35)}
        className="max-w-xl gap-3 mx-auto flex flex-wrap justify-center items-center"
      >
        {/* <div className="tooltip" data-tip="Select Languages"> */}
        <select
        ...
        {/* </div> */}
        {/* <div className="tooltip" data-tip="Select Theme"> */}
        <select
          style={{ flex: '1 1 120px' }}
