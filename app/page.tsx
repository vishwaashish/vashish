          ...
          <div className=" ">
            ...
            >
              <motion.h1
                ...
                className="text-accent-content relative mb-[15px] md:ml-[-10px] md:mb-[37px] font-extrabold text-[14vw] md:text-[100px] lg:text-[110px]  font-inter  leading-[0.9] tracking-[-2px] z-[100]"
              >
                Ashishkumar <br />
              ...
              <div className="flex flex-wrap gap-[15px] mt-8 md:mt-0">
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    // className="btn btn-site group min-w-[180px]"
                    className="pl-[8px] min-w-[180px]   bg-[#1E2B3A] text-white btn btn-site  scale-100"
