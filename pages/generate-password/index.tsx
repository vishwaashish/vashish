...
export default function PasswordGenerator() {
  return (
    <article className="prose lg:prose-md  prose-h1:leading-none  prose-h1:mb-0  text-center  max-w-[900px] mx-auto px-3 py-5 my-7">
      ...
      <p>
        Elevate your digital security with our Random Password Generator. Craft
        strong, unpredictable passwords effortlessly, bolstering your online
        protection against unauthorized access. Stay one step ahead of potential
        threats with ease.
      </p>
      <GeneratePassword />
    </article>
