          ...
          <div className=" ">
            ...
            >
              <motion.h1
                ...
                className="text-accent-content relative mb-[15px] md:ml-[-10px] md:mb-[37px] font-extrabold text-[14vw] md:text-[100px] lg:text-[110px]  font-inter  leading-[0.9] tracking-[-2px] z-1"
              >
                Ashishkumar <br />
              ...
              >
                <div className="">
                  <p className="font-normal max-w-[900px] md:text-lg text-accent-content  ">
                    Passionate about crafting digital experiences with a keen
                    eye for design and a deep love for coding, I bring creative
                    solutions to life through the web. Let&apos;s build
